    ...
    private void setBikeBtnActionHandler(){
        bikeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                checkoutViewModel.setTransportationType(Constants.TransportationType.bikeType);

                //Move to Drop off page
                Navigation.findNavController(requireActivity(), R.id.nav_host_fragment).navigate(R.id.nav_customer_booking);
            }
        });
    }
    ...
    private void setCarBtnActionHandler(){
        carBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Pass data of chosen
                CheckoutViewModel checkoutViewModel = ViewModelProviders.of(requireActivity()).get(CheckoutViewModel.class);
                checkoutViewModel.setTransportationType(Constants.TransportationType.carType);
